...
var btoa = isNode ? function (str) { return Buffer.from(str).toString('base64'); } : window.btoa;
var atob = isNode ? function (str) { return Buffer.from(str, 'base64').toString(); } : window.atob;
/**
